...
import co.luism.lukisoftiot.datacollector.common.DCParserAckNackEvent;
...
final public class DataCollectorParser {
    ...
    private void updateSnapShot(Vehicle vehicle, DataTag tag, Integer timeStamp, Integer TSMilliseconds, long value){
        ...
        WebAppUtils.getInstance().sendDataUpdateEvent(vehicle, EventTypeEnum.TAG_DATA_TYPE_EVENT, timeStamp,  updateItemList);
	...
	private void parseHello(String guId, String[] s) {
        ...
        try {
            ...
            if(diagdInit.compareToIgnoreCase("YES") == 0){
                WebAppUtils.getInstance().backupOldEventData(v);
            }
    ...
    private void storeSystemDataFromLifeSign(String guId, String[] frameValues) {
        ...
        WebAppUtils.getInstance().sendDataUpdateEvent(vehicle, EventTypeEnum.TAG_DATA_TYPE_SYSTEM, timeStamp, listOfUpdateItems);
    }
    ...
    private boolean parseProcessData(String guId, String[] frameValues) {
        ...
        WebAppUtils.getInstance().sendDataUpdateEvent(vehicle, EventTypeEnum.TAG_DATA_TYPE_PD, timeStamp, listOfUpdateItems);
    ...
    private Integer parseProcessDataElement(Vehicle vehicle, int timeStamp, String parsePD) {
        ...
        DataTag t = WebAppUtils.getInstance().findTagBySourceTagId(EventTypeEnum.TAG_DATA_TYPE_PD, vehicle.getConfigurationId(), id);
    ...
    private boolean parseEventData(String guId, String[] frameValues) {
        ...
        WebAppUtils.getInstance().sendDataUpdateEvent(vehicle, EventTypeEnum.TAG_DATA_TYPE_EVENT, timeStamp, listOfUpdateItems);
        return true;
    }
    ...
    private int parseEventDataElement(Vehicle vehicle, String parseEVT) {
        ...
        //find matching tag id
        DataTag t = WebAppUtils.getInstance().findTagBySourceTagId(EventTypeEnum.TAG_DATA_TYPE_EVENT,vehicle.getConfigurationId(), sourceTagId);
