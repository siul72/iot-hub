...
import co.luism.datacollector.DataCollectorSocket;
import co.luism.datacollector.DataCollectorTimer;
import co.luism.datacollector.messages.DCLifeSign;
import co.luism.datacollector.messages.DCLifeSignParamEnum;
import co.luism.diagnostics.common.datatypes.UnsignedInteger;
import co.luism.diagnostics.interfaces.IVehicleEventHandler;
...
public class Vehicle extends DiagnosticsPersistent implements Comparable{
    ...
    public void setStatus(VehicleStatusEnum status) {
        ...
        WebManager.getInstance().sendStatusUpdateEvent(this);
